...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="text-center mt-3">{{ __('Add') }} {{ __('Bill') }} </h2>
        ...
        <div class="row justify-content-center">
            ...
            <form method="POST" action="{{route('bills.store' , app()->getLocale())}}">
                @csrf
                            ...
                            <div class="mdc-text-field">
                                <select class="form-control custom-select text-center" name="bill_type_id">
                                    ...
                                    @foreach($billTypes as $billType)
                                        <option value="{{$billType->id}}">{{ app()->getLocale() === 'ar' ?  $billType->name_ar : $billType->name_en}} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
